...
st.markdown("""
    ...
    """,unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1899</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\ROG\Documents\Pembelajaran Mesin\Tugas3_B_11899'
